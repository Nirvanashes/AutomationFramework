...
def update_user_by_id(db: Session, user: schemas.UserBase):
    pass


def update_user_project(user: schemas.UserBase, db: Session):
...
def add_project(project: schemas.ProjectBase, db: Session):
...
def delete_project_by_id(project: schemas.ProjectBase, db: Session):
    pass
